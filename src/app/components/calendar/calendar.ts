  ...
  let VanillaCalendar = (function () {
    function VanillaCalendar(options) {
      ...
      const createDay = function (date) {
        ...
        let weather_date = opts.weatherDates.filter(
          (f) =>
            f.date ===
            date.getFullYear() +
              "-" +
        ...
        if (
          ...
          if (opts.datesFilter) {
            ...
            if (weather_date.length) {
              if (weather_date[0].cuaca === "Gerimis") {
                newDayElem.classList.add("vanilla-weather-gerimis");
              } else if (weather_date[0].cuaca === "libur") {
                newDayElem.classList.add("vanilla-weather-libur");
              } else if (weather_date[0].cuaca === "cerah") {
                newDayElem.classList.add("vanilla-weather-cerah");
              } else {
                newDayElem.classList.add("vanilla-weather-hujan");
              }
