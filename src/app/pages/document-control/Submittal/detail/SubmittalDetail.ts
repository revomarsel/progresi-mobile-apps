...
@Component({
  selector: "SubmittalDetail",
  templateUrl: "./SubmittalDetail.html",
  styleUrls: ["./SubmittalDetail.scss", "../../Global.scss"],
})
export class SubmittalDetail {
  ...
  async getData(refresh?, choice?) {
    ...
    const res = await this.app.cache.getOrSetItem(
      ...
      () =>
        this.ws
          .getAPI("/apiService/DetilSubmittal", {
            id: this.dokumentID,
          })
          .then((res: any) => {
            return res;
